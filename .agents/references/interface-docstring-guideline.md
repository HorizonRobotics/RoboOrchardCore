...
- For decorators or wrapper helpers, including async-target wrappers,
  ...
  helper they return. For async-target wrappers, spell out await or scheduling
  changes when they affect the public contract.
...
- after the first paragraph, can a new caller tell what task this interface
  helps them accomplish and why they would use it
