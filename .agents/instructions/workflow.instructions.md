...
- Before implementation, write a temporary design note in a disposable repository-local scratch path such as `.agents/tmp/designs/`; keep it uncommitted by default.
