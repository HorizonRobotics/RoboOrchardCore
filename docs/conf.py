...
suppress_warnings = [
    ...
    # Existing autoapi examples contain names that sphinx-codeautolink cannot
    # map back onto rendered HTML reliably; suppress these noisy matches so the
    # docs build is gated by actionable warnings only.
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/HorizonRobotics/RoboOrchardCore",
            "html": """
